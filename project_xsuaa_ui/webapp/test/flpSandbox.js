		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapbtpprojectxsuaaui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpprojectxsuaaui-display": {
								"semanticObject": "sapbtpprojectxsuaaui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.projectxsuaaui",
									"url": sap.ui.require.toUrl("sap/btp/projectxsuaaui")
								}
							}
						}
					}
